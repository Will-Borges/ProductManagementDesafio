...
namespace DesafioAutoglass.Core.Application.Services
{
    ...
    public class ProductManagementService : IProductManagementService
    {
        ...
        private readonly IEntityReadRepository<ProductEntity> _productCodeEntityReadRepository;
        private readonly IProviderManagementService _providerManagementtService;
        ...
        {
            _mapper = mapper;
            _productEntityWriteRepository = entityWriteRepository;
            _productCodeEntityReadRepository = productCodeEntityReadRepository;
            _providerManagementtService = providerManagementtService;
        }
